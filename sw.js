self.addEventListener('install', event => {
	...
	event.waitUntil(
		caches.open('qtquickmemo').then(cache => { 
			...
			cache.add('/QtQuickMemoAppWASM/QtQuickMemoApp.html')
			cache.add('/QtQuickMemoAppWASM/QtQuickMemoApp.js')
			cache.add('/QtQuickMemoAppWASM/QtQuickMemoApp.wasm')
			cache.add('/QtQuickMemoAppWASM/QtQuickMemo.png')
			cache.add('/QtQuickMemoAppWASM/qtlogo.svg')
			cache.add('/QtQuickMemoAppWASM/qtloader.js')
			cache.add('/QtQuickMemoAppWASM/manifest.json')
			})
		)
	}
);
